...
import os
CFG_FILE = os.path.join(os.path.dirname(__file__), '../witcheskpi/utils/witches.cfg').replace('\\', '/')
...
ROOT_URLCONF = 'witches.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'witches.wsgi.application'
...
# logging.basicConfig(filename='../log/witches.log', level=logging.DEBUG)
