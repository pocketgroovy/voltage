...
DEFAULT_ENV = 'witches-admin-tools-dev'
...
SECTION_MAP = {
	'witches-admin-tools-dev': 'Dev',
	'witches-admin-tools-staging': 'Staging',
	'witches-admin-tools-production': 'Prod',
}
...
def get_arguments():
	...
	parser.add_argument('--env', default=DEFAULT_ENV, choices=['witches-admin-tools-dev', 'witches-admin-tools-staging', 'witches-admin-tools-production'])
