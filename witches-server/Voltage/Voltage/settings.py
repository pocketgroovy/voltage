...
DATABASES = {
    ...
    'admin_Dev': {
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': get_environment('Dev', 'db_primary_host'),
        'PORT': '27017'
    },
    'admin_Staging': {
        'ENGINE': 'django_mongodb_engine',
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': get_environment('Staging', 'db_primary_host'),
        'PORT': '27017'
    },
    'admin_Prod': {
        'ENGINE': 'django_mongodb_engine',
        ...
        'USER': '',
        'PASSWORD': '',
        'HOST': get_environment('Prod', 'db_primary_host'),
        'PORT': '27017'
    },
}
...
MIDDLEWARE_CLASSES = (
    'witches.middleware.serverAccessLogMiddleware.LogRequestParams',
    ...
    'witches.middleware.url_switching_middleware.URLSwitchingMiddleware',
)

LOGIN_REDIRECT_URL = '/'

ROOT_URLCONF = 'Voltage.urls_current'
...
AMAZON_DEVELOPER_SECRET = '2:Gwu3iqpXkdNKP6uq6pC03yEybuUh-kdVZBpQpNH3MCi2jLC6_tKOnCRfFmbzNScA:sjHXJu90N5XDSUxOI4EVeg=='
TEMP_KEY = "voltage"
if ENVIRONMENT == 'Prod':
    AMAZON_URL = 'https://appstore-sdk.amazon.com/version/1.0/verifyReceiptId/developer/' + AMAZON_DEVELOPER_SECRET
else:
    AMAZON_URL = 'http://curses.en.ent.voltest.com:8080/RVSSandbox/version/1.0/verifyReceiptId/developer/' + TEMP_KEY # sandbox doesn't need the key
...
LOGGING = {
    ...
    'handlers': {
        ...
        'access_log_file': {
            'level': 'INFO',
            'class': 'logging.FileHandler',
            'filename': os.path.join(os.path.dirname(__file__), '../../', 'log/witches_access.log'),
            'formatter': 'access'
        },
        'console': {
            'level': 'DEBUG',
