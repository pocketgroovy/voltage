...
:: see if the version is 1.6
findstr /R "1.6." %JVERFL% >nul 2> nul
set JAVAVERRETVAL=%ERRORLEVEL%

:: if they aren't using 1.6, see if they are using 1.7
if %JAVAVERRETVAL% NEQ 0 findstr /R "1.7." %JVERFL% >nul 2> nul
if %JAVAVERRETVAL% NEQ 0 set JAVAVERRETVAL=%ERRORLEVEL%

:: if they aren't using 1.6 or 1.7, see if they are using 1.8
...
if %JAVAVERRETVAL% NEQ 0 echo Java 1.6, Java 1.7, or Java 1.8 is required. Please upgrade. The current default java version is ...
